...
from .base_layers import DenseLayer, ResidualLayer
...
class TripletInteraction(torch.nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.down_projection = DenseLayer(
            emb_size_edge,
            emb_size_trip,
            activation=activation,
            bias=False,
        )
        self.up_projection_ca = DenseLayer(
            emb_size_bilinear,
            emb_size_edge,
            activation=activation,
            bias=False,
        )
        self.up_projection_ac = DenseLayer(
            emb_size_bilinear,
            emb_size_edge,
            activation=activation,
            bias=False,
